...
--  agregar la fk a la tabla cliente que viene de representamte
ALTER TABLE cliente
ADD CONSTRAINT fk_cliente_representante
FOREIGN KEY (representante_id)
REFERENCES representamte(representante_id);
GO
...
CREATE TABLE detalle_pedido(
    ...
    created_at DETETIME2 NOT NULL
    CONSTRAINT df_detalle_pedido_created_at
    DEFAULT SYSDATETIME(),
    updated_at DETETIME2 NOT NULL
